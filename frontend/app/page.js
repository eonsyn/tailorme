      ...
      <section className="pt-20 pb-16 px-4">
        <div className="max-w-6xl mx-auto text-center">
          <h1 className="text-5xl md:text-7xl font-bold text-gray-900 mb-6 leading-tight">
            AI-Powered
            <span className="block text-primary-600">Resume Tailoring</span>
          </h1>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="card p-8 text-center hover:shadow-lg transition-shadow">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-4">Smart Resume Tailoring</h3>
            ...
            <div className="card p-8 text-center hover:shadow-lg transition-shadow">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-4">Cover Letter Generation</h3>
              <p className="text-gray-600 leading-relaxed">
            ...
            <div className="card p-8 text-center hover:shadow-lg transition-shadow">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-4">Interview Q&A Prep</h3>
              <p className="text-gray-600 leading-relaxed">
